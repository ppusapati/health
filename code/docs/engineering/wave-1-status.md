...
|---|---|---|---|
| 1 | EMPI foundation | SRS-EMPI-001 … 009 | **In progress** — 001, 002, 003 implemented |
...
| SRS-EMPI-004 | Configurable duplicate confidence routing to auto-clear / warning / manual review, no unsafe auto-merge | Scoring and routing implemented; the manual-review queue arrives with merge |
| SRS-EMPI-005 | Merge only through a reviewed workflow | Not started |
| SRS-EMPI-006 | Controlled unmerge from the merge journal | Not started |
